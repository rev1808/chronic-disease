...
class DiseasePrediction:
    # Initialize and Load the Conf`ig File
    ...
    def select_model(self):
        if self.model_name == 'mnb':
            ...
            self.clf = GridSearchCV(DecisionTreeClassifier(), param_grid, cv=3)
        elif self.model_name == 'random_forest':
            # Add hyperparameter tuning for Random Forest
            param_grid = {'n_estimators': [50, 100, 200]}
            self.clf = GridSearchCV(RandomForestClassifier(), param_grid, cv=3)
